...
struct FactoryTraits<PRODUCT1, PRODUCT2, PRODUCT3, PRODUCT4, PRODUCT5,
                   PRODUCT6, PRODUCT7, PRODUCT8, PRODUCT9, NEOLIB::Dummy> 
{ 
public: 
	FactoryTraits(){}
	virtual ~FactoryTraits(){}
...
struct FactoryTraits<PRODUCT1, PRODUCT2, PRODUCT3, PRODUCT4, PRODUCT5,
                   PRODUCT6, PRODUCT7, PRODUCT8, NEOLIB::Dummy, NEOLIB::Dummy> 
{ 
public: 
	virtual ~FactoryTraits(){}
...
struct FactoryTraits<PRODUCT1, PRODUCT2, PRODUCT3, PRODUCT4, PRODUCT5,
                   PRODUCT6, PRODUCT7, NEOLIB::Dummy, NEOLIB::Dummy, NEOLIB::Dummy> 
{ 
public: 
	virtual ~FactoryTraits(){}
...
template <typename PRODUCT1, typename PRODUCT2, typename PRODUCT3, typename PRODUCT4, typename PRODUCT5,
	typename PRODUCT6>
struct FactoryTraits<PRODUCT1, PRODUCT2, PRODUCT3, PRODUCT4, PRODUCT5,
                   PRODUCT6, NEOLIB::Dummy, NEOLIB::Dummy, NEOLIB::Dummy, NEOLIB::Dummy> 
{ 
public: 
	virtual ~FactoryTraits(){}
...
template <typename PRODUCT1, typename PRODUCT2, typename PRODUCT3, typename PRODUCT4, typename PRODUCT5>
struct FactoryTraits<PRODUCT1, PRODUCT2, PRODUCT3, PRODUCT4, PRODUCT5,
                   NEOLIB::Dummy, NEOLIB::Dummy, NEOLIB::Dummy, NEOLIB::Dummy, NEOLIB::Dummy> 
{ 
public: 
	virtual ~FactoryTraits(){}
...
struct FactoryTraits<PRODUCT1, PRODUCT2, PRODUCT3, PRODUCT4, NEOLIB::Dummy,
                   NEOLIB::Dummy, NEOLIB::Dummy, NEOLIB::Dummy, NEOLIB::Dummy, NEOLIB::Dummy> 
{ 
public: 
	virtual ~FactoryTraits(){}
...
struct FactoryTraits<PRODUCT1, PRODUCT2, PRODUCT3, NEOLIB::Dummy, NEOLIB::Dummy,
                   NEOLIB::Dummy, NEOLIB::Dummy, NEOLIB::Dummy, NEOLIB::Dummy, NEOLIB::Dummy> 
{ 
public: 
	virtual ~FactoryTraits(){}
...
struct FactoryTraits<PRODUCT1, PRODUCT2, NEOLIB::Dummy, NEOLIB::Dummy, NEOLIB::Dummy,
                   NEOLIB::Dummy, NEOLIB::Dummy, NEOLIB::Dummy, NEOLIB::Dummy, NEOLIB::Dummy> 
{ 
public: 
	virtual ~FactoryTraits(){}
...
struct FactoryTraits<PRODUCT1, NEOLIB::Dummy, NEOLIB::Dummy, NEOLIB::Dummy, NEOLIB::Dummy,
                   NEOLIB::Dummy, NEOLIB::Dummy, NEOLIB::Dummy, NEOLIB::Dummy, NEOLIB::Dummy> 
{ 
public: 
	FactoryTraits(){
...
template <typename PRODUCT1=NEOLIB::Dummy, typename PRODUCT2=NEOLIB::Dummy, typename PRODUCT3=NEOLIB::Dummy,
	typename PRODUCT4=NEOLIB::Dummy, typename PRODUCT5=NEOLIB::Dummy,typename PRODUCT6=NEOLIB::Dummy, typename PRODUCT7=NEOLIB::Dummy, 
	typename PRODUCT8=NEOLIB::Dummy, typename PRODUCT9=NEOLIB::Dummy, typename PRODUCT10=NEOLIB::Dummy>
